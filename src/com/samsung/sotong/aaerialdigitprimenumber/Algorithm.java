package com.samsung.sotong.aaerialdigitprimenumber;
...
[Output]
Output one N-digit serial digit prime number in each line in an ascending order. 
If there is not one serial digit prime number with the given digit, output 0. 
Each test case must be output separately as a empty line. (Last test case also need a empty line.)
