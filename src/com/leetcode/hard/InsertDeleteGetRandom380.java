...
public class InsertDeleteGetRandom380 {
	...
	private Map<Integer, Integer> collections = new HashMap<Integer,Integer>(); //<hashcode,val>
	private int collecSize = 0;
    ...
    public boolean insert(int val) {
    	boolean isPresent = collections.containsValue(val);
    	if (isPresent) {
			return false;
		}
    	int hashCode = Integer.hashCode(val);
    	collections.put(hashCode, val);
    	++collecSize;
    	String tempStr = String.valueOf(collecSize);
    ...
    public boolean remove(int val) {
    	...
    	collections.remove(Integer.hashCode(val));
    	--collecSize;
    	String tempStr = String.valueOf(collecSize);
    	bitCount = tempStr.length();
    	return true;
